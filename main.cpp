...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (game.input[0][0] >= 0)
        {
            ...
            textrenderer.render_text(game.map_player(game.input[0][0]),
        ...
        if (game.input[0][1] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[0][1]),
        ...
        if (game.input[0][2] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[0][2]),
        ...
        if (game.input[1][0] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[1][0]),
        ...
        if (game.input[1][1] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[1][1]),
        ...
        if (game.input[1][2] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[1][2]),
        ...
        if (game.input[2][0] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[2][0]),
        ...
        if (game.input[2][1] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[2][1]),
        ...
        if (game.input[2][2] >= 0)
        {
            textrenderer.render_text(game.map_player(game.input[2][2]),
